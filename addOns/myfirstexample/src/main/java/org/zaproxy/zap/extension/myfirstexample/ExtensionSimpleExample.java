...
public class ExtensionSimpleExample extends ExtensionAdaptor {
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        if (getView() != null) {
            ...
            extensionHook.getHookView().addWorkPanel(new MyWorkPanel("WorkPanel", LOGGER));
        ...
        // add ScannerHook...
        LOGGER.debug("MyFirstScannerHook addScannerHook..");
        extensionHook.addScannerHook(new MyFirstScannerHook());
        // add listener
        extensionHook.addHttpSenderListener(new MyFirstSenderListener(LOGGER));
    }
